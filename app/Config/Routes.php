...
$routes->group('/', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('actualizarHoraSalidaPedido', 'Ventas::actualizarHoraSalidaPedido');
    ...
    $routes->get('detalle-cambio-prod/(:num)', 'Administracion::detalleCambioProd/$1');
    ...
    $routes->post('arreg-menos-vendidos', 'Estadisticas::estArregloMenosVendidos');
    $routes->get('arreg-menos-vendidos-excel', 'Estadisticas::arregMenosVendidosExcel');
    ...
    //TESTS
    $routes->get('/ventas/pedidoInsertTest', 'TestsVentas::pedidoInsertTest');
});