                    ...
                    <form action="<?= site_url().'clientes-frecuentes';?>" method="post">
                        <div class="card-body">
                            <div class="row col-md-12">
                                ...
                                <div class="form-group col-md-2 control-reporte" id="div-fecha">
                                ...
                                <div class="form-group col-md-2 control-reporte" id="div-link-limpiar">
                                    <a href="#" id="txt-limpiar">Limpiar controles</a>
                                </div>
                                <div class="form-group col-md-2 mt-2 control-reporte">
                                    <label for="sugest">   </label>
                                    <a href="<?= site_url();  ?>clientes-frecuentes" class="btn btn-light btn-reinicia" id="btn-reinicia" target="_self">Reiniciar reporte</a>
                                </div>
                                <div class="form-group col-md-2 control-reporte">
                                    <label for="mes"></label>
                                    <input 
