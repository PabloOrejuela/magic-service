...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?= site_url(); ?>public/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?= site_url(); ?>public/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?= base_url(); ?>public/images/AdminLTELogo.png" alt="logo" height="60" width="60">
  </div>
